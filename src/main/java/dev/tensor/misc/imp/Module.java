...
public abstract class Module implements Global, Methods {
    ...
    protected void enable() {
        ...
        if (!this.isNull()) {
            onEnable();
            if (isMessages()) this.sendReplaceableClientMessage(Formatting.GREEN + getName() + " ENABLED!", 665, true);
        }
    }
    ...
    protected void disable() {
        ...
        if (!this.isNull()) {
            onDisable();
            if (isMessages()) this.sendReplaceableClientMessage(Formatting.RED + getName() + " DISABLED!", 665, true);
        }
    }
