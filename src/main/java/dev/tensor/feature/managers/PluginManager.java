...
public final class PluginManager implements Manager {
    ...
    public void load() {
        ...
        FabricLoader.getInstance().getEntrypointContainers(Tensor.INSTANCE.MOD_NAME.toLowerCase(Locale.ROOT), Plugin.class).forEach(pluginEntrypointContainer -> this.plugins.add(pluginEntrypointContainer.getEntrypoint()));
