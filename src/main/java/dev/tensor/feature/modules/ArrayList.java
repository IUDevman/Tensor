...
public final class ArrayList extends Module {
    ...
    public void onRender2D() {
        ...
        ModuleManager.INSTANCE.getModules().forEach(module -> {
            ...
            DrawableHelper.drawStringWithShadow(matrixStack, this.getMinecraft().textRenderer, module.getName(), this.x.getValue().intValue(), this.y.getValue().intValue() + incrementY.get(), new Color(255, 255, 255, 255).getRGB());
            incrementY.getAndAdd(this.getMinecraft().textRenderer.fontHeight);
        });
    }
}
